...
def fake_img():
    ...
    if img is not None and not img.empty():
        ...
        print("Error loading fake image")
...
def genuine_img():
    ...
    if img is not None and not img.empty():
        ...
        print("Error loading genuine image")
...
test_images500 = cvutils.imlist("fake500")
test_images2000 = cvutils.imlist("fake2000")
...
for i in range(len(test_images500)):
    if i < len(X_test500):
    # Read the image
...
for i in range(len(test_images2000)):
    if i < len(X_test500):
        # Read the image
